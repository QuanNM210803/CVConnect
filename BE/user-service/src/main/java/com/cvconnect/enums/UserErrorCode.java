...
public enum UserErrorCode implements ErrorCode {
    ...
    USER_NOT_PHONE_NUMBER(1028, Messages.USER_NOT_PHONE_NUMBER, HttpStatus.NOT_FOUND),
    ORG_ADDRESS_AT_LEAST_ONE(1029, Messages.ORG_ADDRESS_AT_LEAST_ONE, HttpStatus.BAD_REQUEST)
    ;
