...
public enum CoreErrorCode implements ErrorCode {
    ...
    INDUSTRY_SUB_CODE_DUPLICATED(3022, Messages.INDUSTRY_SUB_CODE_DUPLICATED, HttpStatus.BAD_REQUEST),
    INDUSTRY_SUB_CODE_EXISTS(3023, Messages.INDUSTRY_SUB_CODE_EXISTS, HttpStatus.BAD_REQUEST)
    ;
