...
public enum CoreErrorCode implements ErrorCode {
    ...
    FULL_NAME_REQUIRED(4001, Messages.FULL_NAME_REQUIRED, HttpStatus.BAD_REQUEST),
    EMAIL_REQUIRED(4002, Messages.EMAIL_REQUIRED, HttpStatus.BAD_REQUEST),
    PHONE_REQUIRED(4003, Messages.PHONE_REQUIRED, HttpStatus.BAD_REQUEST),
    CANDIDATE_NOT_FOUND(4004, Messages.CANDIDATE_NOT_FOUND, HttpStatus.NOT_FOUND),
    CANDIDATE_INFO_APPLY_NOT_FOUND(4005, Messages.CANDIDATE_INFO_APPLY_NOT_FOUND, HttpStatus.NOT_FOUND),
    JOB_AD_NOT_FOUND(4006, Messages.JOB_AD_NOT_FOUND, HttpStatus.NOT_FOUND),
    JOB_AD_EXPIRED(4007, Messages.JOB_AD_EXPIRED, HttpStatus.BAD_REQUEST),
    JOB_AD_STOP_RECRUITMENT(4008, Messages.JOB_AD_STOP_RECRUITMENT, HttpStatus.BAD_REQUEST)
