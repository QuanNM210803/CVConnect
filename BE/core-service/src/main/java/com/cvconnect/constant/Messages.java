...
public class Messages {
    ...
    * Error Messages
    * */
    public static final String UPLOAD_FILE_QUANTITY_EXCEED_LIMIT = "upload.file.quantity.exceed.limit";
    ...
    * */
    ...
    public static final String CAREER_CODE_REQUIRED = "career.code.required";
